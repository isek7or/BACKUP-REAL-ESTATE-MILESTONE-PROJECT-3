                                    ...
                                    <div key={listedProperty._id} className={classes.property}>
                                        ...
                                        <div className={classes.details}>
                                            ...
                                            <div className={classes.moreDetails}>
                                                ...
                                                <span>{listedProperty?.sqft} sq. feet<FaSquareFull className={classes.icon} /></span>
                                            </div>
                                    ...
                                    <div key={bookmarkedProperty._id} className={classes.property}>
                                        ...
                                        <div className={classes.details}>
                                            ...
                                            <div className={classes.moreDetails}>
                                                ...
                                                <span>{bookmarkedProperty?.sqft} sq. feet<FaSquareFull className={classes.icon} /></span>
                                            </div>
                                            <div className={classes.desc}>
